...
# Widgets: model, bar, ctx, tokens, cost, duration, lines, alert, git, project, version, vim
...
IFS='	' read -r model used_pct total_input total_output cost_usd exceeds_200k project_dir duration_ms lines_added lines_removed cc_version vim_mode <<EOF
$_parsed
EOF
